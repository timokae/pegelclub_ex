defmodule PegelclubExWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {PegelclubExWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: PegelclubExWeb.Telemetry
    end
  end
  ...
  scope "/", PegelclubExWeb do
    ...
    get "/users", UserSettingsController, :index
